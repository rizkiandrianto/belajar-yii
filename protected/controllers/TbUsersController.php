...
class TbUsersController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['TbUsers'];
			if($model->save())
	...
	{
		$model=TbUsers::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param TbUsers $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tb-users-form')
		{
